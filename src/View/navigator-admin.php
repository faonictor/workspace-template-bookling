            ...
            <li class="nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            ...
                            <a href="./mybooksList.php" class="d-flex align-items-center gap-2 dropdown-item">
                                <i class="ti ti-books fs-6"></i>
                                <p class="mb-0 fs-3">Meus Livros</p>
                            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            ...
                            <a href="./authentication-login.php" class="btn btn-outline-primary mx-3 mt-2 d-block">Sair</a>
                        </div>
                    </div>
                </li>
            </ul>
