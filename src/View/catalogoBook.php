...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <!--  Sidebar End -->
    <!--  Main wrapper -->
    <div id="catalogo" class="body-wrapper">
      <!--  Header Start -->
      <!--  Header End -->
        ...
        <div class="card overflow-hidden rounded-2">
          ...
          <div class="card-body pt-3 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="fw-semibold fs-4 mb-0">R$ 69,90 <span class="ms-2 fw-normal text-muted fs-3"><del>R$ 89,90</del></span></h6>
              <ul class="list-unstyled d-flex align-items-center mb-0">
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star"></i></a></li>
                <li><a class="" href="javascript:void(0)"><i class="ti ti-star"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
          ...
          <div class="card-body pt-3 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="fw-semibold fs-4 mb-0">R$ 29,90 <span class="ms-2 fw-normal text-muted fs-3"><del>R$</del></span></h6>
              <ul class="list-unstyled d-flex align-items-center mb-0">
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
          ...
          <div class="card-body pt-3 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="fw-semibold fs-4 mb-0">R$ 89,90 <span class="ms-2 fw-normal text-muted fs-3"><del>R$ 120,00</del></span></h6>
              <ul class="list-unstyled d-flex align-items-center mb-0">
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
          ...
          <div class="card-body pt-3 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="fw-semibold fs-4 mb-0">R$ 39,90 <span class="ms-2 fw-normal text-muted fs-3"><del>R$ 55,00</del></span></h6>
              <ul class="list-unstyled d-flex align-items-center mb-0">
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star"></i></a></li>
